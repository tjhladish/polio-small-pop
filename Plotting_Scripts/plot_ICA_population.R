...
filter_3500_no_pcase = read.table(paste0(dir,'e_and_d_values-0pcase_filter_det_1_N_3500_beta_135_fast.out'), col.names=c('time', 'E&D'))
filter_3500_1_pcase = read.table(paste0(dir,'e_and_d_values-1pcase_filter_det_1_N_3500_beta_135_fast.out'), col.names=c('time', 'E&D'))
...
filter_10000_1_pcase = read.table(paste0(dir,'e_and_d_values-1pcase_filter_det_1_N_10000_beta_135_fast.out'), col.names=c('time', 'E&D'))
filter_5000_no_pcase = read.table(paste0(dir,'e_and_d_values-0pcase_filter_det_1_N_5000_beta_135_fast.out'), col.names=c('time', 'E&D'))
filter_5000_1_pcase = read.table(paste0(dir,'e_and_d_values-1pcase_filter_det_1_N_5000_beta_135_fast.out'), col.names=c('time', 'E&D'))
...
filter_25000_1_pcase = read.table(paste0(dir,'e_and_d_values-1pcase_filter_det_1_N_25000_beta_135_fast.out'), col.names=c('time', 'E&D'))
marker = list(color = brewer.pal(8,"GnBu"))
png(paste0(dir,'Population_size_on_ED_statistic_ED_pres.png'), width=1200, height=800, res=150)
